...
# This script is restricted to boundary-condition analysis for the Prevention Theorem.
# It computes time-dependent establishment probabilities and PEP efficacy only.
# No post-integration dynamics are modeled here.
