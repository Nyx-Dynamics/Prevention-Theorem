...
\textbf{Reconciled numerical-claims summary.} A reconciled summary of all numerical claims with source files and commit references is provided as \texttt{numerical\_claims\_v2.csv} accompanying this submission. Every numerical claim in the v2 manuscript and supplement is traceable to a specific output file at the cited SHA. The submitted code is archived at Zenodo (code DOI: \texttt{10.5281/zenodo.20044747}; dataset DOI: \texttt{10.5281/zenodo.20044747}); these DOIs reflect a fresh deposit at the v2-submission tag and supersede any prior deposits referenced in earlier correspondence.
