...
Adds a stochastic layer to PEP_parenteral.py addressing the core
...
THEORETICAL SIGNIFICANCE:
    The deterministic model (PEP_parenteral.py) gives:
...
VL DISTRIBUTION PARAMETERS (empirical basis):
    ...
    PEP_parenteral.py — NOT the VL distribution center.
...
from PEP_parenteral import ParenteralExposureModel, REFERENCE_LOG10_VL
